...
import type { CollectionSchema, FieldDiff, SchemaDiff } from '@data-engine/schema';
...
export interface MigrationOperation {
  type: 'addField' | 'removeField' | 'alterField' | 'createCollection' | 'dropCollection' | 'addForeignKey' | 'createJunctionTable';
  collection: string;
  field?: string;
  definition?: unknown;
  changes?: unknown;
